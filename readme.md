...
# Group Features:
1. View study groups
2. View resource posts
3. View help requests
4. Ask for help (form)
5. Share resource (form)
6. View answers to questions
7. Can post files

# USER JOINING THE GROUP
1. user can join the group
2. after joining group is added to his profile
3. after joing join btn's text is converted into "open"
4. user is added into group's users in database and on UI too.
5. user can send msg in group

# USER'S PROFILE 
1. User's profile shows the groups he has joined
